<?php
    class Movement
    {
        ...
        {
            $DB = self::Connect();
            return $DB->fetchAssoc('movement a INNER JOIN movement_type b ON (a.type_id=b.type_id) LEFT JOIN payment c ON (c.payment_id=a.payment_id)','a.*,b.title AS type,b.operation,c.title AS payment','customer_id='.$ID,'a.creation_date DESC,a.type_id');
        }
