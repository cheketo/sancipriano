...
class GeolocationProvince extends DataBase
{
	var $Data 		= array();
	var $Zones 		= array();
	var $ID;
	...
	public function GetData()
	{
		if(!$this->Data)
		{
			$Data 		= $this->fetchAssoc($this->Table,"*",$this->TableID."=".$this->ID);
			$this->Data = $Data[0];
			if($this->Data['country_id'])
			{
				$Data	= $this->fetchAssoc('admin_country','*','country_id = '.$this->Data['country_id']);
