...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2017 at 01:01 AM
...
(80, 1, 'hernan', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Hernan', 'Balboa', 'hernanbalboa@gmail.com', 333, '../../../skin/images/users/default/default10.png', 'A', 0, 0, '', '', '', 0, '2017-03-08 00:20:05', '2016-11-17 20:52:43', 8),
...
(73, 76, 'Crear', '../provider_national_purchase_order/new.php', 'fa-cart-plus', 1, 'N', 'A', 'A'),
(74, 76, 'Ordenes Pendientes', '../provider_national_purchase_order/list.php?status=P', 'fa-shopping-cart', 4, 'N', 'A', 'A'),
(75, 76, 'Editar', '../provider_national_purchase_order/edit.php', 'fa-cart-arrow-down', 0, 'N', 'O', 'A'),
(76, 55, 'Ordenes de Compra', '#', 'fa-shopping-cart', 10, 'N', 'A', 'A'),
(77, 76, 'Ordenes Activas', '../provider_national_purchase_order/list.php?status=A', 'fa-bars', 5, 'N', 'A', 'A'),
(78, 76, 'Ordenes Finalizadas', '../provider_national_purchase_order/list.php?status=F', 'fa-check-square-o', 6, 'N', 'A', 'A');
...
(1, 1, 11, 2, 'A4', '2333', 0, 15, 60, '122x45', '122.34', '0.00', '0.00', '', 'Descripción: este es un producto de prueba', 'A', '2016-12-13 19:19:36', '2016-12-13 19:19:36', 8, 0),
(2, 1, 28, 1, '2AJ5', 'NKI 15/16', 0, 10, 100, '14x19x16', '23.00', '0.00', '0.00', '', '', 'A', '2016-12-13 20:17:17', '2016-12-13 20:17:17', 8, 8),
(3, 1, 26, 2, '', '6203 DDU', 0, 0, 0, '', '0.00', '0.00', '0.00', '', '', 'A', '2016-12-14 18:17:30', '2016-12-14 18:17:30', 80, 0);
...
INSERT INTO `product_provider` (`provider_id`, `type`, `name`, `corporate_name`, `company_id`, `country_id`, `province_id`, `region_id`, `zone_id`, `address`, `postal_code`, `lat`, `lng`, `email`, `phone`, `fax`, `cuit`, `gross_income_tax`, `iva`, `website`, `logo`, `status`, `creation_date`, `last_update`, `created_by`, `updated_by`) VALUES
...
CREATE TABLE IF NOT EXISTS `product_provider_agent` (
  `agent_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `product_provider_agent` (`agent_id`, `provider_id`, `name`, `charge`, `email`, `phone`, `extra`) VALUES
...
CREATE TABLE IF NOT EXISTS `product_provider_purchase_order` (
...
INSERT INTO `product_provider_purchase_order` (`order_id`, `provider_id`, `agent_id`, `currency_id`, `type`, `total`, `delivery_date`, `extra`, `status`, `payment_status`, `delivery_status`, `company_id`, `creation_date`, `created_by`, `modification_date`, `updated_by`) VALUES
(1, 2, 0, 2, 'N', '765.27', '2017-03-01 00:00:00', 'Información de prueba', 'P', 'P', 'P', 1, '2017-02-23 18:18:22', 8, '2017-03-03 18:01:56', 0),
(2, 2, 0, 2, 'N', '758.00', '2017-02-28 00:00:00', '', 'A', 'P', 'P', 1, '2017-02-23 20:27:31', 8, '2017-03-03 19:41:45', 0),
(3, 3, 0, 2, 'N', '154.00', '2017-03-16 00:00:00', '', 'P', 'P', 'P', 1, '2017-02-23 20:32:16', 8, '2017-02-23 20:32:16', 0);
...
CREATE TABLE IF NOT EXISTS `product_provider_purchase_order_item` (
...
INSERT INTO `product_provider_purchase_order_item` (`item_id`, `order_id`, `provider_id`, `product_id`, `currency_id`, `quantity`, `price`, `status`, `payment_status`, `delivery_date`, `creation_date`, `created_by`, `company_id`) VALUES
(1, 1, 2, 1, 2, 12, '12.12', 'P', 'P', '2017-02-21 00:00:00', '2017-02-23 18:18:22', 8, 1),
(2, 1, 2, 2, 2, 11, '1.91', 'P', 'P', '2017-02-21 00:00:00', '2017-02-23 18:18:22', 8, 1),
(3, 1, 2, 3, 2, 120, '2.99', 'P', 'P', '2017-02-21 00:00:00', '2017-02-23 18:18:22', 8, 1),
(4, 1, 2, 1, 2, 22, '10.91', 'P', 'P', '2017-02-14 00:00:00', '2017-02-23 18:18:22', 8, 1),
(5, 2, 2, 1, 2, 1, '333.00', 'P', 'P', '2017-01-30 00:00:00', '2017-02-23 20:27:31', 8, 1),
(6, 2, 2, 3, 2, 4, '44.00', 'P', 'P', '2017-02-14 00:00:00', '2017-02-23 20:27:31', 8, 1),
(7, 2, 2, 2, 2, 3, '43.00', 'P', 'P', '2017-02-01 00:00:00', '2017-02-23 20:27:31', 8, 1),
(8, 2, 2, 2, 2, 3, '2.00', 'P', 'P', '2017-03-10 00:00:00', '2017-02-23 20:27:31', 8, 1),
(9, 2, 2, 2, 2, 34, '3.00', 'P', 'P', '2017-03-07 00:00:00', '2017-02-23 20:27:31', 8, 1),
(10, 2, 2, 3, 2, 2, '3.00', 'P', 'P', '2017-02-15 00:00:00', '2017-02-23 20:27:31', 8, 1),
(11, 2, 2, 3, 2, 2, '3.00', 'P', 'P', '2017-02-16 00:00:00', '2017-02-23 20:27:31', 8, 1),
(12, 3, 3, 1, 2, 8, '8.00', 'P', 'P', '2017-02-01 00:00:00', '2017-02-23 20:32:16', 8, 1),
(13, 3, 3, 3, 2, 6, '6.00', 'P', 'P', '2017-02-02 00:00:00', '2017-02-23 20:32:16', 8, 1),
(14, 3, 3, 2, 2, 7, '7.00', 'P', 'P', '2017-03-16 00:00:00', '2017-02-23 20:32:16', 8, 1),
(15, 3, 3, 1, 2, 1, '1.00', 'P', 'P', '2017-02-09 00:00:00', '2017-02-23 20:32:16', 8, 1),
(16, 3, 3, 3, 2, 2, '2.00', 'P', 'P', '2017-01-06 00:00:00', '2017-02-23 20:32:16', 8, 1);
